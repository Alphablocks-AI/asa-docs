...
<Frame>
  <img src="/images/shopify-legacy-connect-dialog.png" alt="Connect to Shopify Legacy dialog with Client ID, Client Secret, Storefront Public URL, and Shopify Subdomain" />
</Frame>
...
<Warning>
The Asa Shopify app is currently in App Store review. Until it is approved, follow the **Custom app** tab above.
</Warning>
...
A short message confirms your store name. Click **Integrate** to finish the connection.

**B — Full connect dialog**  
If you connect manually from the Shopify card, confirm both fields:

| Field | What to enter |
|---|---|
| **Shopify subdomain** | The part before `.myshopify.com` (e.g. `acme` from `acme.myshopify.com`) |
| **Website link** | Your public storefront URL (e.g. `https://acme.com`) |

<Frame>
  <img src="/images/shopify-connect-dialog.png" alt="Connect to Shopify dialog with Shopify subdomain and Website link fields" />
</Frame>

Click **Connect** or **Integrate**, depending on which dialog you see.
...
<Frame>
  <img src="/images/shopify-content-select-dialog.png" alt="Shopify content selection dialog with Products, Blogs, Pages, and Policies categories" />
</Frame>
...
<Frame>
  <img src="/images/shopify-metafields-dialog.png" alt="Select Metafields dialog for Shopify product metafields" />
</Frame>
