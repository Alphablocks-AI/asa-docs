...
_If you can’t access the _**_Dev Dashboard_**_ section, you may not have the required setup/permissions. Check _[_Shopify’s guide_](https://help.shopify.com/en/manual/apps/app-types/custom-apps)_ or contact your store admin. If you’re still having trouble, feel free to reach out to us at _[**_help@alphablocks.ai_**](mailto:help@alphablocks.ai)**_._**
